                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="admin_cont.php?controller=index&action=exportar" method="post" id="form_export" class="row g-3">
                            ...
                            <!-- <div id="pernr_trab" class="col-md-4">
                                <span style="font-weight: bold;"><?php echo $lang['nombre']; ?>, PERNR: </span>
                                <input type="text" class="form-control" name="pernr_trab" <?php if (isset($_POST['pernr_trab']) && $_POST['pernr_trab'] != "") { echo "value='" . $_POST['pernr_trab'] . "'"; } ?>>
                            </div> -->
